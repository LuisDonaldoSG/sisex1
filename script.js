let arr = [
    {puntos : [
        {materia : 'Sistemas operativos', num : 0},
        {materia : 'Programación de sistemas', num : 0},
        {materia : 'Arquitectura de sistemas de red', num : 0},
        {materia : 'Sistemas operativos aplicados', num : 0},
        {materia : 'Mantenimiento de equipo de computo', num : 0},
        {materia : 'Habilidades de comunicación', num : 0},
        {materia : 'Administración de proyectos de red', num : 0},
        {materia : 'Prácticas de redes', num : 0},
        {materia : 'Metodología de la investigación', num : 0},
        {materia : 'Estructura de datos', num : 0},
        {materia : 'Principios de telecomunicaciones', num : 0},
        {materia : 'Seguridad', num : 0},
        {materia : 'Administración de servidores', num : 0},
        {materia : 'Administración avanzada de servicios', num : 0},
        {materia : 'Análisis de protocolos', num : 0},
        {materia : 'Enrutamiento básico', num : 0},
        {materia : 'Enrutamiento avanzado', num : 0},
        {materia : 'Redes inalámbricas', num : 0},
        {materia : 'Redes WAN', num : 0},
        {materia : 'Administración de proyectos de red', num : 0},
        {materia : 'Programación segura', num : 0},
        {materia : 'Arquitectura en red', num : 0},
        {materia : 'Programación en la administración de redes', num : 0},
        {materia : 'Lectura y redacción a través del análisis del mundo contemporáneo', num : 0},
        {materia : 'Probabilidad y estadística para computación', num : 0},
        {materia : 'Persona y proyecto de vida', num : 0},
        {materia : 'Ética y profesión', num : 0},
        {materia : 'Diseño y desarrollo de videojuegos', num : 0},
        {materia : 'Diseño y proyectos de investigación', num : 0},
        {materia : 'Sensores y actuadores', num : 0},
        {materia : 'Diseño de compiladores', num : 0},
        {materia : 'Gráficas por computadora', num : 0},
        {materia : 'Ingeniería de software', num : 0},
        {materia : 'Ingeniería de software II', num : 0},
    ]},
    {
